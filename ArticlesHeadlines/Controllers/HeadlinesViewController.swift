...
class HeadlinesViewController: UIViewController {
  ...
  func fetchHeadlines() {
    ...
    headlines = [
      ...
      HeadlineViewModel(Headline(title: "test 3", description: "testing", author: "rex", url:"", urlToImage: "https://d2jx2rerrg6sh3.cloudfront.net/images/news/ImageForNews_766206_17017494326985532.jpg")),
      HeadlineViewModel(Headline(title: "test 4", description: "testing again", author: "rex", url: "", urlToImage: "")),
    ]
  }
}
